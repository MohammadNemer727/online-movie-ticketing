...
namespace BookMyTickets.Controllers
{
    public class UsersController : Controller
    {
        ...
        {
            var userDetails = _context.Users.Where(x => x.Email == user.Email).FirstOrDefault();
            var phone = _context.Users.Where(x => x.Email == user.Email).FirstOrDefault();
            if (userDetails == null)
            {
                if (phone == null)
                {
                ...
                {
                    ModelState.AddModelError("", "Phone number already Exist");
                    return View("Create");
                }
            }
            else
        ...
        public IActionResult SignInForUser(User user)
        {
                ...
                var userDetails = _context.Users.Where(x => x.Email == user.Email && x.Password == user.Password).FirstOrDefault();
